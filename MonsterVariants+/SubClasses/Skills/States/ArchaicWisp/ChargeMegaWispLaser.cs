...
namespace MonsterVariantsPlus.SubClasses.Skills.States.ArchaicWisp
{
    public class ChargeMegaWispLaser : BaseState
    {
        ...
        public override void FixedUpdate()
        {
            ...
            {
                FireMegaWispLaser nextState = new FireMegaWispLaser();
