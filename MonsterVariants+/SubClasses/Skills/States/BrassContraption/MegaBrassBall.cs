...
namespace MonsterVariantsPlus.SubClasses.Skills.States.BrassContraption
{
    public class MegaBrassBall : BaseState
    {
        ...
        public override void OnEnter()
        {
            ...
            currentBombIndex = 1;
            bombProjectilePrefab = Prefabs.Projectiles.BrassContraption.MegaBrassBallPrefab.prefab;
